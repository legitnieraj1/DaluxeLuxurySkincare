...
/**
 * Sub-component to handle the actual login form and search params logic.
 * Needs to be wrapped in <Suspense> because of useSearchParams().
 */
...
export default function LoginPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#0B0B0B' }}>
      ...
      <Suspense fallback={<Loader2 className="animate-spin" size={32} color="#D4AF37" />}>
        <LoginFormComponent />
      </Suspense>
    </div>
  );
