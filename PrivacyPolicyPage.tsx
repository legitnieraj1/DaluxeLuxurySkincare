...
const PRIVACY_SECTIONS = [
  { icon: Eye, title: 'Introduction', content: 'DaLuxe Skincare Pvt. Ltd. ("DaLuxe", "we", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our Platform and purchase our products.\n\nBy using the Platform, you consent to the practices described in this Policy.' },
